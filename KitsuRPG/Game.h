...
{
public:
	CCharacter		Adventurer = {CHARACTER_TYPE_PLAYER, 10, 1, 50, 100, "Anonymous"}; //MaxHP, ATk, HitChance, Coins.
};
...
void combat(CCharacter& adventurer, ENEMY_TYPE enemyType);	// Combat is executed from the mercenary job menu and executes the battle turns until one of the combatants is dead.
