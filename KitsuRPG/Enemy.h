...
static const CCharacter enemyDefinitions[] =	{	{CHARACTER_TYPE_ENEMY,	250+(rand()%50), 8+(rand()%5), 80+(rand()%20), 100+(rand()%20), "Unknown (a character that spawns due to a bug)"}
												...
												,	{CHARACTER_TYPE_ENEMY,	25,		4,	45,	40,		"Knight"	} //type, MaxHP, Atk, HitChance, dropCoins, name.
												,	{CHARACTER_TYPE_ENEMY,	50,		7,	55,	75,		"Dragon"	} //type, MaxHP, Atk, HitChance, dropCoins, name.
												};
