...
static bool equipIfResearchedAccessory	(SGame& instanceGame, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_USER]; return equipIfResearched(selectedChoice, player.Army, player.Goods.Inventory.Accessory	, player.Army[player.Squad.Agents[player.Selection.PlayerUnit]].CurrentEquip.Accessory		, player.Squad, player.Selection, player.Goods.CompletedResearch.Accessory		, definitionsAccessory		, modifiersAccessory	, "Crafting"		, "Accessories"	, instanceGame.UserMessage, instanceGame.UserError);};
static bool equipIfResearchedStageProp	(SGame& instanceGame, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_USER]; return equipIfResearched(selectedChoice, player.Army, player.Goods.Inventory.StageProp	, player.Army[player.Squad.Agents[player.Selection.PlayerUnit]].CurrentEquip.StageProp		, player.Squad, player.Selection, player.Goods.CompletedResearch.StageProp		, definitionsStageProp		, modifiersStageProp	, ""				, "Stage Props"	, instanceGame.UserMessage, instanceGame.UserError);};
static bool equipIfResearchedFacility	(SGame& instanceGame, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_USER]; return equipIfResearched(selectedChoice, player.Army, player.Goods.Inventory.Facility		, player.Army[player.Squad.Agents[player.Selection.PlayerUnit]].CurrentEquip.Facility		, player.Squad, player.Selection, player.Goods.CompletedResearch.Facility			, definitionsFacility		, modifiersFacility		, "Architectonics"	, "Facilities"	, instanceGame.UserMessage, instanceGame.UserError);};
static bool equipIfResearchedVehicle	(SGame& instanceGame, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_USER]; return equipIfResearched(selectedChoice, player.Army, player.Goods.Inventory.Vehicle		, player.Army[player.Squad.Agents[player.Selection.PlayerUnit]].CurrentEquip.Vehicle		, player.Squad, player.Selection, player.Goods.CompletedResearch.Vehicle			, definitionsVehicle		, modifiersVehicle		, "Transportation"	, "Vehicles"	, instanceGame.UserMessage, instanceGame.UserError);};
static bool equipIfResearchedProfession	(SGame& instanceGame, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_USER]; return equipIfResearched(selectedChoice, player.Army, player.Goods.Inventory.Profession	, player.Army[player.Squad.Agents[player.Selection.PlayerUnit]].CurrentEquip.Profession		, player.Squad, player.Selection, player.Goods.CompletedResearch.Profession		, definitionsProfession		, modifiersProfession	, "Rank"			, "Licenses"	, instanceGame.UserMessage, instanceGame.UserError);};
static bool equipIfResearchedWeapon		(SGame& instanceGame, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_USER]; return equipIfResearched(selectedChoice, player.Army, player.Goods.Inventory.Weapon		, player.Army[player.Squad.Agents[player.Selection.PlayerUnit]].CurrentEquip.Weapon			, player.Squad, player.Selection, player.Goods.CompletedResearch.Weapon			, definitionsWeapon			, modifiersWeapon		, "Science"			, "Weapons"		, instanceGame.UserMessage, instanceGame.UserError);};
static bool equipIfResearchedArmor		(SGame& instanceGame, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_USER]; return equipIfResearched(selectedChoice, player.Army, player.Goods.Inventory.Armor		, player.Army[player.Squad.Agents[player.Selection.PlayerUnit]].CurrentEquip.Armor			, player.Squad, player.Selection, player.Goods.CompletedResearch.Armor			, definitionsArmor			, modifiersArmor		, "Technology"		, "Armors"		, instanceGame.UserMessage, instanceGame.UserError);};
