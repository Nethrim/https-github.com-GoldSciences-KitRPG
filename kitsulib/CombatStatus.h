...
#define MAX_PASSIVE_EFFECT_COUNT 3
	...
	,	EQUIP_TECHNOLOGY_CHEMICAL	= 0x0004
	,	EQUIP_TECHNOLOGY_BALLISTIC	= 0x0008
	,	EQUIP_TECHNOLOGY_LAUNCHER	= 0x0010
	,	EQUIP_TECHNOLOGY_DIGITAL	= 0x0020
	,	EQUIP_TECHNOLOGY_GENETIC	= 0x0040
	,	EQUIP_TECHNOLOGY_SOUND		= 0x0080
	,	EQUIP_TECHNOLOGY_MICROWAVE	= 0x0100
	,	EQUIP_TECHNOLOGY_RADIACTIVE	= 0x0200
	,	EQUIP_TECHNOLOGY_RAY		= 0x0400
	,	EQUIP_TECHNOLOGY_SATELLITE	= 0x0800
	};
