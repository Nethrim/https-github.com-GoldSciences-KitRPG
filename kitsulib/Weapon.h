...
//
,	{	{	{	3,	0,	0	},	{	0,	0,	0	},	{	0,	0,	},	0	,{},{	COMBAT_STATUS_NONE		}	, EQUIP_TECHNOLOGY_BASIC												},	"Soldier's %s"			}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	0,	0,	},	3	,{},{	COMBAT_STATUS_NONE		}	, EQUIP_TECHNOLOGY_BASIC												},	"Assassin's %s"			}
...
,	{	{	{	0,	0,	0	},	{	3,	0,	0	},	{	0,	0,	},	0	,{},{	COMBAT_STATUS_NONE		}	, EQUIP_TECHNOLOGY_BASIC												},	"Saint's %s"			}
//
,	{	{	{	4,	0,	0	},	{	0,	0,	0	},	{	0,	0,	},	0	,{},{	COMBAT_STATUS_NONE		}	, EQUIP_TECHNOLOGY_BASIC												},	"Executioner's %s"		}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	0,	0,	},	4	,{},{	COMBAT_STATUS_NONE		}	, EQUIP_TECHNOLOGY_BASIC												},	"Stalker's %s"			}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	0,	3,	},	0	,{},{	COMBAT_STATUS_BURN		}	, EQUIP_TECHNOLOGY(EQUIP_TECHNOLOGY_DIGITAL)							},	"Plasma %s"				}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	0,	3,	},	0	,{},{	COMBAT_STATUS_POISON	}	, EQUIP_TECHNOLOGY(EQUIP_TECHNOLOGY_DIGITAL)							},	"Radiactive %s"			}
,	{	{	{	0,	0,	0	},	{	4,	0,	0	},	{	0,	0,	},	0	,{},{	COMBAT_STATUS_NONE		}	, EQUIP_TECHNOLOGY_BASIC												},	"Angel's %s"			}
,	{	{	{	0,	0,	0	},	{	0,	4,	0	},	{	0,	0,	},	0	,{},{	COMBAT_STATUS_NONE		}	, EQUIP_TECHNOLOGY_BASIC												},	"Wizard's %s"			}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	0,	0,	},	0	,{	ATTACK_EFFECT_LEECH_HEALTH	},{}, EQUIP_TECHNOLOGY_BASIC												},	"Vampire's %s"			}
//
...
,	{	{	{	3,	0,	0	},	{	0,	0,	0	},	{	0,	2,	},	0,	{},{	COMBAT_STATUS_STUN											},	EQUIP_TECHNOLOGY_BASIC													},	"Club"						}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	4,	1,	},	0,	{},{	COMBAT_STATUS_BLIND											},	EQUIP_TECHNOLOGY_BASIC													},	"Knuckle"					}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	4,	1,	},	0,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY_BASIC													},	"Dagger"					}
,	{	{	{	1,	0,	0	},	{	0,	0,	0	},	{	1,	3,	},	0,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY_BASIC													},	"Spiked Club"				}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	2,	3,	},	0,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY_BASIC													},	"Knife"						}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	3,	2,	},	0,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY_BASIC													},	"Claw"						}
// 4th grade	six	
,	{	{	{	2,	0,	0	},	{	0,	0,	0	},	{	1,	3,	},	0,	{},{	COMBAT_STATUS_STUN											},	EQUIP_TECHNOLOGY_BASIC													},	"Mace"						}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	2,	4,	},	0,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY_BASIC													},	"Machete"					}
...
// 3rd grade	seven
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	2,	5,	},	0,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY(EQUIP_TECHNOLOGY_MECHANIC)								},	"Crossbow"					}
,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	1,	6,	},	0,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY(EQUIP_TECHNOLOGY_MECHANIC)								},	"Pistol"					}
,	{	{	{	1,	0,	0	},	{	0,	0,	0	},	{	1,	5,	},	0,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY(EQUIP_TECHNOLOGY_MECHANIC)								},	"Rifle"						}
,	{	{	{	2,	0,	0	},	{	0,	0,	0	},	{	-2,	7,	},	0,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY(EQUIP_TECHNOLOGY_MECHANIC)								},	"Shotgun"					}
,	{	{	{	1,	0,	0	},	{	0,	0,	0	},	{	0,	5,	},	1,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY(EQUIP_TECHNOLOGY_MECHANIC)								},	"Machinegun"				}
,	{	{	{	-2,	0,	0	},	{	0,	0,	0	},	{	2,	7,	},	0,	{},{	(COMBAT_STATUS)(COMBAT_STATUS_BLIND|COMBAT_STATUS_BLEEDING)	},	EQUIP_TECHNOLOGY(EQUIP_TECHNOLOGY_MECHANIC)								},	"Sniper Rifle"				}
,	{	{	{	2,	0,	0	},	{	0,	0,	0	},	{	0,	6,	},	-1,	{},{	(COMBAT_STATUS)(COMBAT_STATUS_STUN|COMBAT_STATUS_BURN)		},	EQUIP_TECHNOLOGY(EQUIP_TECHNOLOGY_MECHANIC)								},	"Rocket Launcher"			}
,	{	{	{	0,	-3,	0	},	{	0,	0,	0	},	{	6,	6,	},	-2,	{},{	(COMBAT_STATUS)(COMBAT_STATUS_STUN|COMBAT_STATUS_BURN)		},	EQUIP_TECHNOLOGY(EQUIP_TECHNOLOGY_DIGITAL|EQUIP_TECHNOLOGY_MECHANIC)	},	"Guided Rocket Launcher"	}
// 2nd grade	eight
,	{	{	{	1,	0,	0	},	{	1,	0,	0	},	{	-1,	7,	},	0,	{},{	COMBAT_STATUS_STUN											},	EQUIP_TECHNOLOGY_BASIC													},	"Thor's Mace"				}
,	{	{	{	1,	0,	0	},	{	1,	0,	0	},	{	-1,	7,	},	0,	{},{	COMBAT_STATUS_BLIND											},	EQUIP_TECHNOLOGY_BASIC													},	"Zeus' Staff"				}
,	{	{	{	1,	0,	0	},	{	1,	0,	0	},	{	-1,	7,	},	0,	{},{	COMBAT_STATUS_BLEEDING										},	EQUIP_TECHNOLOGY_BASIC													},	"Anhur's Spear"				}
,	{	{	{	1,	0,	0	},	{	1,	0,	0	},	{	-1,	7,	},	0,	{},{	DEATH_SCYTHE_STATUS_INFLICT									},	EQUIP_TECHNOLOGY_BASIC													},	"Death Scythe"				}
// 1st grade	ten
,	{	{	{	1,	0,	0	},	{	0,	0,	0	},	{	1,	8,	},	0,	{},{	(COMBAT_STATUS)(COMBAT_STATUS_BURN|COMBAT_STATUS_POISON)	},	EQUIP_TECHNOLOGY_BASIC													},	"BFG-9000"					}
};
