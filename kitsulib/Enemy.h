...
#define DEATH_STATUS_INFLICT ((STATUS_TYPE)(STATUS_TYPE_BLIND|STATUS_TYPE_STUN|STATUS_TYPE_BLEEDING|STATUS_TYPE_BURN|STATUS_TYPE_FREEZE|STATUS_TYPE_POISON|STATUS_TYPE_PETRIFY))
