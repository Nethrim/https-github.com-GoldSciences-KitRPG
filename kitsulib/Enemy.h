...
namespace klib
{
	...
	,	{CHARACTER_TYPE_ENEMY,	8,		55,		8,		85	,	ATTACK_EFFECT_NONE,	DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE	,	COMBAT_STATUS_NONE		,	(COMBAT_STATUS)(COMBAT_STATUS_POISON|COMBAT_STATUS_BLEEDING)	,	"Behemot"	}	
	,	{CHARACTER_TYPE_ENEMY,	9,		60,		9,		90	,	ATTACK_EFFECT_NONE,	DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE	,	COMBAT_STATUS_SLEEP		,	COMBAT_STATUS_NONE							,	"Jean Grey"	}	
	,	{CHARACTER_TYPE_ENEMY,	10,		60,		10,		100	,	ATTACK_EFFECT_NONE,	DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE	,	COMBAT_STATUS_NONE		,	COMBAT_STATUS_SLEEP							,	"Cthulhu"	}	
