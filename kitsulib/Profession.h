...
namespace klib
{
	...
	{	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	0,	0,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Nobody"			}
	,	{	{	{	2,	0,	1	},	{	0,	0,	0	},	{	1,	2,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Swordman"		}
	,	{	{	{	0,	1,	0	},	{	0,	1,	0	},	{	1,	3,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Mage"			}
	,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	3,	2,	},	1	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Thief"			}
	,	{	{	{	1,	2,	0	},	{	1,	1,	0	},	{	1,	0,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Acolyte"		}
	,	{	{	{	2,	0,	0	},	{	0,	0,	0	},	{	0,	2,	},	2	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Merchant"		}
	,	{	{	{	2,	0,	0	},	{	0,	0,	0	},	{	2,	2,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Archer"			}
	,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	3,	3,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Sniper"			}
	,	{	{	{	2,	1,	0	},	{	0,	0,	0	},	{	1,	2,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Driver"			}
	,	{	{	{	1,	0,	1	},	{	0,	0,	0	},	{	2,	2,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Raider"			}
	...
	,	{	{	{	1,	0,	0	},	{	0,	0,	0	},	{	1,	4,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Sorcerer"		}
	,	{	{	{	1,	0,	0	},	{	2,	0,	0	},	{	2,	1,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Medic"			}
	,	{	{	{	1,	0,	0	},	{	0,	0,	0	},	{	3,	2,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Ninja"			}
	,	{	{	{	1,	1,	0	},	{	0,	0,	0	},	{	0,	4,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Grenadier"		}
	,	{	{	{	1,	0,	0	},	{	1,	1,	0	},	{	0,	2,	},	1	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Biochemist"		}
	,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	2,	4,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Assassin"		}
	,	{	{	{	2,	0,	0	},	{	0,	0,	0	},	{	1,	3,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Engineer"		}
	,	{	{	{	2,	0,	0	},	{	0,	0,	0	},	{	0,	4,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Executioner"	}
	,	{	{	{	1,	1,	0	},	{	0,	0,	0	},	{	2,	2,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Commando"		}
	,	{	{	{	1,	1,	0	},	{	0,	0,	0	},	{	1,	3,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Sectoid"		}
	,	{	{	{	0,	0,	0	},	{	0,	0,	2	},	{	2,	2,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Android"		}
	,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	2,	4,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_BURN	,	COMBAT_STATUS_BLEEDING	}, "Drone"			}
	,	{	{	{	2,	1,	0	},	{	1,	0,	0	},	{	0,	2,	},	0	,	ATTACK_EFFECT_LEECH,	DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_MANA_REGEN		,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Vampire"		}
	,	{	{	{	2,	0,	0	},	{	1,	0,	0	},	{	0,	3,	},	0	,	ATTACK_EFFECT_LEECH,	DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Valkyr"			}
	,	{	{	{	2,	1,	0	},	{	2,	1,	0	},	{	0,	0,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_SHIELD_REPAIR	,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Trinity"		}
	,	{	{	{	3,	2,	0	},	{	0,	0,	0	},	{	0,	2,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Rhino"			}
	,	{	{	{	0,	0,	0	},	{	0,	0,	0	},	{	4,	2,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Mesa"			}
	,	{	{	{	0,	1,	1	},	{	0,	1,	1	},	{	0,	2,	},	0	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_NONE	,	COMBAT_STATUS_NONE		}, "Mag"			}
	,	{	{	{	0,	3,	0	},	{	0,	1,	0	},	{	0,	1,	},	1	,	ATTACK_EFFECT_NONE,		DEFEND_EFFECT_NONE	,	PASSIVE_EFFECT_NONE				,	COMBAT_STATUS_BLIND	,	COMBAT_STATUS_NONE		}, "Loki"			}
	};
