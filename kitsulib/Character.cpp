...
SCharacterPoints klib::calculateFinalPoints(const CCharacter& character)
{
	...
	result.Points.LifeMax		= character.CombatBonus.Points.LifeMax		+ weaponPoints.Points.LifeMax		+ armorPoints.Points.LifeMax		+ professionPoints.Points.LifeMax		+	character.Points.Points.LifeMax;
	result.Points.Attack		= character.CombatBonus.Points.Attack		+ weaponPoints.Points.Attack		+ armorPoints.Points.Attack			+ professionPoints.Points.Attack		+	character.Points.Points.Attack;
	result.Points.LifeCurrent	= character.CombatBonus.Points.LifeCurrent	+ weaponPoints.Points.LifeCurrent	+ armorPoints.Points.LifeCurrent	+ professionPoints.Points.LifeCurrent;
	result.Points.Coins			= character.CombatBonus.Points.Coins		+ weaponPoints.Points.Coins			+ armorPoints.Points.Coins			+ professionPoints.Points.Coins;

	result.Flags				= character.CombatBonus.Flags | weaponPoints.Flags	| armorPoints.Flags	| professionPoints.Flags | character.Points.Flags;
